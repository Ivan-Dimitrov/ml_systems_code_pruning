...
def main(args):
    ...
    compression.full_prune(encoder, .01)
    compression.full_prune(decoder, .01)
...
def load_checkpoint(args, trainer, epoch_itr):
    ...
    updated_file_path = 'trained_ch.pt'
    checkpoint_path = os.path.join(args.save_dir, updated_file_path)
